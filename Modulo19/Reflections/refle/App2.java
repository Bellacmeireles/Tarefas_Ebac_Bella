package Modulo19.Reflections.refle;

import javax.swing.JOptionPane;

import Modulo19.Reflections.refle.dao.ClienteMapDAO;
import Modulo19.Reflections.refle.dao.IClienteDAO;
import Modulo19.Reflections.refle.dao.IProdutoDAO;
import Modulo19.Reflections.refle.dao.ProdutoDAO;
import Modulo19.Reflections.refle.dao.generic.IGenericDAO;
...
import Modulo19.Reflections.refle.exception.TipoChaveNaoEncontradaException;
import Modulo19.Reflections.refle.fabrica.FabricaPersistente;
import Modulo19.Reflections.refle.fabrica.Factory;
import Modulo19.Reflections.refle.fabrica.IFactory;
...
public class App2 {
    ...
    public static void main(String[] args) {
        ...
        while (!isOpcaoMenuValida(opcaoMenuGeral)) {
            ...
            opcaoMenuGeral = JOptionPane.showInputDialog(null,
                    "Opção inválida digite 1 para Cliente ou 2 para Produto", "Cadastro",
     ...
     *                       </ol>
     *                       </b>
     * @param opcaoMenuGeral Opção selecionada no menu inicial da aaplicação - <b>1
     *                       para cliente e 2 para produto</b>
     */
    private static void executarOpcoes(String opcao, String opcaoMenuGeral) {
        try {
            ...
            JOptionPane.showMessageDialog(null, e.getMessage(), "ERRO DE VALIDAÇÃO DE DADOS",
                    JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private static void executarOpcaoAtualizar(String opcaoMenuGeral) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "ERRO DE SISTEMA. CONTATE O ADMINISTRADOR DESTE SISTEMA", "Erro",
                    JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    private static void executarOpcaoExcluir(String opcaoMenuGeral) {
        ...
        JOptionPane.showMessageDialog(null, "Dados excluídos com sucesso: ", "Sucesso",
                JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private static void executarOpcaoConsultar(String opcaoMenuGeral) {
        ...
        if (persistente != null) {
            JOptionPane.showMessageDialog(null, "Dado encontrado: " + persistente.toString(), "Sucesso",
                    JOptionPane.INFORMATION_MESSAGE);
        } else {
    ...
    /**
     * Método que retorna a instância correta do DAO para o tipo de dados desejado
     * ou selecionado
     *
     * @param opcaoMenuGeral Opção selecionada no menu inicial da aaplicação - <b>1
     *                       para cliente e 2 para produto</b>
     * @return <code>IGenericDAO</code> interface genérica que contém os métodos de
     *         CRUD
     */
     ...
     * @param opcaoMenuGeral Opção selecionada no menu inicial da aaplicação - <b>1
     *                       para cliente e 2 para produto</b>
     * @return retorna o objeto <b>Persistente</b> que é pai de todas as entidades
     *         da aplicação
     */
    ...
    private static void cadastrar(String dados, String opcaoMenuGeral) throws DadosInvalidosException {
        ...
        try {
            ...
            if (isCadastrado) {
                JOptionPane.showMessageDialog(null, "Dados cadastrado com sucesso ", "Sucesso",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "Dados já se encontra cadastrado", "Erro",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (TipoChaveNaoEncontradaException e) {
            JOptionPane.showMessageDialog(null, "ERRO DE SISTEMA. CONTATE O ADMINISTRADOR DESTE SISTEMA", "Erro",
     ...
     * @param opcaoMenuGeral Opção selecionada no menu inicial da aaplicação - <b>1
     *                       para cliente e 2 para produto</b>
     * @param persistente    objeto pai que representa todas as entidades da
     *                       aplicação
     * @return
     */
