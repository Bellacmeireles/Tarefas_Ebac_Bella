...
public class TelaApp {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Se a opção não for valida (ou seja for invalida) então eu valido ( ai vai pro metodo isOpcaoValida que tem todas as opções) ai se voltar e não der ai faz o else opco que é pra mostrar a mensagem de novo pedindo as opções.
         */
